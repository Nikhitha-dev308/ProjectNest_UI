...
const Login = () => {
  ...
  return (
    ...
    <div className='bg-white p-8 rounded-2xl shadow-lg w-120 h-110 max-w-m'>
        ...
        <button onClick={handleLogin}  className='w-full py-2 bg-[#0447a5] text-white rounded-lg font-medium mt-5 hover:bg-[#122860] transition duration-300' type="submit">Login</button>
        </form>
